...
gene_tumor_type_targets_Sorafenib_project = {
    ...
    # Sorafenib targets:
    "BRAF": ["pan_cancer"], #["LIHC"], #, "pan_cancer"],
    "RAF1": ["pan_cancer"] #["LIHC"], #, "pan_cancer"],
...
#             # Save results
            keys = results[0].keys()
            with open(
                    PATH_save_results + "Comparison_grid/grid_Perturbations_analysis_LIHC_sorafenib_targets2.csv",
            ...
            with open(
                    PATH_save_results + "Comparison_grid/best_models_Perturbations_analysis_LIHC_sorafenib_targets2.csv",
                    'w', newline='') as output_file:
                dict_writer = csv.DictWriter(output_file, keys)
                dict_writer.writeheader()
